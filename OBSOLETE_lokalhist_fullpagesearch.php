...
// FINNE ANTALL TREFF
$lokalhistoriewikiantalltreff = count ($treffliste);

// ... SÅ HVERT ENKELT TREFF
	$teller = 0;
	foreach ($treffliste as $treff) {
		$treffurl = str_replace (" " , "_" , $treff);			
		$lokalhistoriewikitreff[$teller]['url'] = "http://lokalhistoriewiki.no/index.php/" . $treffurl;
		$lokalhistoriewikitreff[$teller]['tittel'] = $treff;
...
foreach ($lokalhistoriewikitreff as $singeltreff) {
	$lokalhistoriewikitreffhtml = "<div class=\"lokalhistorieresult lokalhistoriwikitreff\">\n";
	$lokalhistoriewikitreffhtml .= '<a target="_blank" class="lokalhistorieresultlink" href="' . $singeltreff['url'] . '">' . "\n";
	$lokalhistoriewikitreffhtml .= '<b>' . $singeltreff['tittel'] . '</b>';
	$lokalhistoriewikitreffhtml .= '</a><br>' . "\n";
       
    $lokalhistoriewikihtml .= $lokalhistoriewikitreffhtml;
}
