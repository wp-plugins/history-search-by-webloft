...
$singlehtml .= "<h3 style=\"margin: 0; padding: 0; line-height: 1.1em;\">titleString</h3>";
...
foreach ($treff as $enkelttreff) {
	...
	@$treffvariant = str_replace ("<br>" , ". " , $enkelttreff['beskrivelse']);
	@$outhtml = str_replace ("descriptionString" , trunc(strip_tags($treffvariant), 50) , $outhtml);
